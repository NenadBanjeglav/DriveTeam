...
const HeroSection = () => {
  return (
    <header
      id="home"
      className="relative flex h-screen flex-col items-center justify-center bg-[url('/hero.jpg')] bg-cover bg-center"
    >
      <div className="flex w-full flex-col items-center justify-center rounded bg-black/50 p-8 py-12 text-center text-white shadow-lg">
        <Link
